...
<h1>Add New Venue</h1>
<c:url var="saveUrl" value="/venues/add"/>
<form:form cssClass="form-horizontal" modelAttribute="venueAttribute" method="POST" action="${saveUrl}">
	...
	<div class="form-group">
		<form:label cssClass="col-sm-2 control-label" path="keeperId">Contact Person:</form:label>
		<form:input cssClass="form-control" path="keeperId"/>
	</div>
	<div class="form-group">
